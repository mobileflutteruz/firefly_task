...
class ThemeTextStyles extends ThemeExtension<ThemeTextStyles> {
  ...
  static const ThemeTextStyles light = ThemeTextStyles(
    ...
    phoneNumberStyle: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.w400,),
  );
  ...
  ThemeExtension<ThemeTextStyles> copyWith({
    ...
    TextStyle? bodyTitle3,
      ...
      ThemeTextStyles(
        ...
        phoneNumberStyle: phoneNumberStyle ?? phoneNumberStyle
      );
  ...
  ThemeExtension<ThemeTextStyles> lerp(
    ...
    return ThemeTextStyles(
      ...
      phoneNumberStyle: TextStyle.lerp(phoneNumberStyle, other.phoneNumberStyle, t)!,
    );
  }
}
